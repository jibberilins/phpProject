...
<?php
    //The following code is used to drag the turbine specifications into a table. This is 
	//based on which turbine is selected from above.
...
<?php
	 ...
	 */
     ...
     include("MySQL2_open_connection.php");
		...
		To perform the calculations, the user has to fill in the form below and submit it.
		The user will then be taken to the output screen were they will be shown their output.
...
?>	 
   ...
   <form action= "process_output.php""<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
...
<?php	
//This code sends the user to the output page
if (isset($_POST['windCal']))    // if calculate button has been submitted
	...
	//Checks fields
          ...
          else
        {
		 ...
		 header("Location: process_output.php"); 
